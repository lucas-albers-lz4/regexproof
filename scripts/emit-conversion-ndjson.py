...
SHAPE = {
    ...
    "FC-forge-cli-url-userinfo-coverage": 2,
    "FC-forge-cli-jaas-escaped-quote-coverage": 4,
    "FC-forge-cli-sensitive-env-key-coverage": 2,
    "FC-forge-cli-dmm-error-secret-coverage": 4,
    "FC-forge-cli-llm-query-secret-coverage": 4,
