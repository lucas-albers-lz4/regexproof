...
SHAPE = {
    ...
    "FC-forge-cli-url-password-no-space": 1,
    "FC-forge-cli-dmm-value-no-semicolon": 1,
    "FC-forge-cli-llm-userinfo-no-at": 1,
    "FC-forge-cli-jaas-escaped-quote-covered": 2,
    "FC-forge-cli-sensitive-env-key-covered": 2,
