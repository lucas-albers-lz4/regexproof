...
<!-- provenance: 78 triage files, inputs b5d0c23374a2, 836 gate decisions -->
...
- Input files: 78
- Triage inputs hash: `b5d0c23374a240e0`
- Gate decisions: 836
- Total unencodable rows: 46899
- Total weighted sites: 137788.0
...
| 8 | `internal-anchor` | 488 | 1425.0 | go:1347.0, triage-trial:78.0 | posix-shell:480, ecma:7, pcre:1 |
| 9 | `unsupported:POSSESSIVE_REPEAT` | 466 | 1398.0 | go:1398.0 | py_re:466 |
| 10 | `m-flag` | 442 | 1256.0 | go:1191.0, no-go:25.0, triage-trial:40.0 | py_re:369, ecma:73 |
| 11 | `multi-match` | 435 | 1229.0 | go:1173.0, no-go:32.0, triage-trial:24.0 | py_re:435 |
| 12 | `negated-shorthand` | 423 | 1198.0 | go:1104.0, no-go:16.0, triage-trial:78.0 | py_re:245, ecma:175, re2:2, yara:1 |
| 13 | `backref` | 380 | 1087.0 | go:1056.0, no-go:25.0, triage-trial:6.0 | py_re:348, ecma:31, posix-shell:1 |
| 14 | `per-alternative-anchor` | 362 | 1035.0 | go:942.0, no-go:3.0, triage-trial:90.0 | ecma:187, posix-shell:100, py_re:70, re2:3 |
...
| 19 | `parse-error` | 118 | 353.0 | go:351.0, triage-trial:2.0 | pcre:53, ecma:50, posix-shell:8, yara:7 |
