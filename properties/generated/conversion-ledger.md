...
Synthesis considers at most `synth_max_sites` (default 200, sort by `regex_id`) per corpus. validator.js is the only corpus with properties asked; its batch summary already records `synth_max_sites`.
