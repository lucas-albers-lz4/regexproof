...
| stage | count |
|---|---|
| sites extracted (batch summaries) | 134,985 |
| sites encodable | 83,565 |
| scanner NDJSON rows | 9,499 |
| planned inventory stubs | 322 |
| classification rows (usage/intent/triage kinds) | 7,889 |
...
| encodable / extracted excluding YARA inventories | 0.5988 |
| YARA share of inventory unencodable | 0.6002 |
| `fullword-boundary` share of inventory unencodable | 0.5839 |
