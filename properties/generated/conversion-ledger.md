...
| properties asked (non-planned product kinds) | 26 |
| properties asked distinct `(site, question_id)` | 26 |
| properties UNSAT (holds in declared domain) | 19 |
| properties SAT | 6 |
...
Asked in tools: 3. Asked elsewhere: 23. SAT in tools: 2. SAT elsewhere: 4.
...
- demand_open (open gated:go clusters lacking a closed wave): **63**
- admission_per_week (GO gate-decision artifacts, last 7-day window ending 2026-08-26): **2**
- backlog_weeks = demand_open / admission_per_week = **31.5**
