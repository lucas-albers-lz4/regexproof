...
- [1. Complement() is language complement](#1-complement-is-language-complement-not-char-class-negation)
- [2. seq backend vs z3str3](#2-the-seq-backend-solves-regex-z3str3-returns-unknown-instantly)
- [3. NUL is a real edge](#3-nul-0x00-is-a-real-edge--state-input-domain-assumptions)
- [4. Deny-list unreachable is ambiguous](#4-deny-list-unreachable-is-ambiguous)
- [5. re.replace_re / str.replace_all unsupported](#5-rereplace_re-strreplace_all-are-not-supported)
- [6. Regex unfolding is incomplete](#6-regex-unfolding-is-incomplete-with-string-constraints)
- [7. SubString with symbolic indices](#7-substring-with-symbolic-indices-is-expensive)
- [8. FullRe is NOT exported](#8-fullre-is-not-exported-in-z3py-500)
- [9. Length bounds are load-bearing](#9-length-bounds-are-load-bearing)
- [10. unknown is NOT sat](#10-unknown-is-not-sat)
- [11. Lookaheads/lookbehinds not expressible](#11-lookaheadslookbehinds-are-not-expressible-in-stock-z3)
- [12. Presence-gates use whole-word grep](#12-presence-gates-must-use-whole-word-grep--substring-matches-lie)
- [13. Re(...) is a LITERAL](#13-re-is-a-literal-not-a-pattern-parse)
- [14. Char-range boundaries are load-bearing](#14-char-range-boundaries-are-load-bearing--off-by-one-silently-includes-neighbors)
- [15. Opt is the optimizer class](#15-opt-is-the-optimizer-class-not-regex-optional)
- [16. Case-insensitive mirror](#16-case-insensitive-flags-the-mirror-must-expand-case)
- [17. Unicode classes](#17-unicode-classes-the-input-domain-assumption-is-load-bearing)
- [18. Search-wrapped rule_diff blows up Z3](#18-search-wrapped-rule_diff-blows-up-z3)
- [19. ModSecurity @rx escapes quotes](#19-modsecurity-rx-strings-escape-quotes-as-)
- [20. Exact {1} / {1,1} Concat](#20-exact-1--11-must-not-call-z3-concat-with-one-arg)
- [21. Pattern-too-long](#21-pattern-too-long-is-a-capacity-policy-not-a-language-limit)
- [22. ECMA flags](#22-ecma-flags-m--u--v--sticky-gyd--reject-dont-approximate)
- [23. Hex escapes lower to codepoint](#23-hex-escapes-must-lower-to-the-codepoint-not-literal-text)
- [24. ReDoS wall-clock gate](#24-redos-fan-out-uses-a-wall-clock-gate-not-a-count-cap)
- [25. ASCII-domain word boundary](#25-ascii-domain-b-encode--never-silent-unicode-mirrors)
- [26. Dialect whitespace complement](#26-dialect-s-on-complement--s-must-use-dialect-space-codes)
- [27. Per-alternative anchors](#27-per-alternative-anchors-and-literal---)
- [28. Pattern-final alt-dollar A1B](#28-pattern-final---a1b-lowering-accept-class-boundary)
- [29. YARA encoding domain](#29-yara-encoding-domain-declaration-ascii-vs-wide)
- [30. Semgrep denominator precision](#30-semgrep-denominator-precision-pattern-vs-pattern-regex)
- [31. Testdata sample vs full](#31-testdata-sample-vs-full-complete_run-silent-fallback)
- [32. Cross-engine parity](#32-cross-engine-parity-discipline-re2-vs-pcre)
- [33. Caret-in-X vs A1B](#33-caret-in-x-vs-a1b-do-not-widen-a1b)
- [34. Perl dialect frontier](#34-perl-dialect-frontier-k-code-assertions-posix-x)
- [35. (?x) whitespace strip](#35-x-whitespacecomment-strip-class-aware)
- [36. Secret-detector pack](#36-secret-detector-pack-pattern-vs-regex)
- [37. ECMA sanitizer boundary](#37-ecma-sanitizer--validator-boundary-dompurify--email)
- [38. Testdata full-suite vs sample](#38-testdata-full-suite-vs-sample-expected-file-manifests)
- [Escape-input class](#escape-input-class-4-confirmed-occurrences-now-a-rule--220)
- [p{} silent literalization](#p-silent-literalization-u9-evidence--226220)
- [Signal deaths are negative returncodes](#signal-deaths-are-negative-returncodes-s13--230)
